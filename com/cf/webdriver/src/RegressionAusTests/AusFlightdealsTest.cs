...
namespace TestWebDriver.com.cf.webdriver.src.RegressionAusTests
{
    [TestFixture]
    [Category("Regression")]
    public class AusFlightDealsTest
    {
        ...
        public void TestFlightdeals()
        {
            ...
            try
            {
                ...
                flightDealsModule.GetFlightdealsPage().SearchFlightDeals(context, BaseModule.DataLookup["fromsourceAu"],
        ...
        public void TestFlightDealsFixed()
        {
            ...
            try
            {
                ...
                flightModule.GetFlightdealsPage().FixedSearchAu(context, BaseModule.DataLookup["fromSourceAuIATA"], BaseModule.DataLookup["toDestinationIATA"]);
