    ...
    public class AusHotDealsTest
    {
        ...
        public void TestDisplayHandPickedDeals()
        {
            ...
            try
            {
                ...
                staffPicksModule.GetStaffPicksPage().Handpickdeals(context, BaseModule.ObjectLookup["Hotdeals"]);
        ...
        public void TestDisplayDate()
        {
            ...
            try
            {
                ...
                staffPicks.GetStaffPicksPage().CheckDatePosted(context, BaseModule.ObjectLookup["Hotdeals"]);
        ...
        public void TestDisplayHeader()
        {
            ...
            try
            {
                context = Drivercontext.Create("StaffPicksTests", BaseModule.GetobjLookup(), WebSiteUrlFromConfig, Utility.GetFireFoxDriver());
                StaffPicksModule staffPicks = new StaffPicksModule();
                staffPicks.GetStaffPicksPage().CheckHeader(context, BaseModule.ObjectLookup["Hotdeals"]);
