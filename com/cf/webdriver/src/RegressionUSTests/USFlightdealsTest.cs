...
namespace TestWebDriver.com.cf.webdriver.src.RegressionUSTests
{
    [TestFixture]
    [Category("Regression")]
    public class USFlightdealsTest
    {
        [SetUp]
        ...
        public void TestFlightdeals()
        {
            ...
            try
            {
                ...
                flightDealsModule.GetFlightdealsPage().SearchFlightDeals(context, BaseModule.DataLookup["toDestination"],
                    BaseModule.DataLookup["fromSource"], BaseModule.DataLookup["fromDateUS"], BaseModule.DataLookup["toDateUS"]);
        ...
        public void TestFlightDealsFixed()
        {
            ...
            try
            {
                ...
                flightModule.GetFlightdealsPage().FixedSearch(context, BaseModule.DataLookup["fromSourceUSIATA"], 
                    BaseModule.DataLookup["toDestinationIATA"], BaseModule.DataLookup["fromDateUS"], 
                    BaseModule.DataLookup["toDateUS"]);
